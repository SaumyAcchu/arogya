  ...
  <!--===========top nav end===========-->
      ...
      <label><span>*</span> Fields are required.</label>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" value="<?= set_value('sponcer_id',$this->logged['sponcer_id']); ?>" class="form-control txtupper" id="sponcer_id" placeholder="Enter Sponcer ID" required readonly>
                <span id="err_sponcer"></span>
            </div>
            <label class="col-lg-2 control-label">Activation PIN</label>
            <div class="col-lg-4">
                <input type="text" value="<?= set_value('pin',$this->logged['pin']); ?>" class="form-control" id="pin" placeholder="Enter Activation PIN" readonly>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" value="<?= set_value('fname',$this->logged['fname']); ?>" name="fname" class="form-control" id="fname" placeholder="">
