...
<div class="col-lg-12">
	<div class="panel panel-info txtSize">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="fa fa-sitemap"></i> Commison On Team Bussiness </h3>
		</div>
		<div class="panel-body">
			<table class="table table-bordered table-hover table-striped" border="1" cellpadding="5" width="100%">
	            <thead>
				...
				<table class="table table-bordered table-hover table-striped">
		            <thead>
		                ...
		                <tr>
		                  	...
		                  	<th colspan="3">Admin</th><td>&#8377; <?=$admin;?></td>
		                </tr>  <tr>
		                  	<th colspan="3">TDS</th><td>&#8377; <?=$tds;?></td>
		                </tr>  <tr>
		                  	<th colspan="3">TRUST</th><td>&#8377; <?=$trust;?></td>
		                </tr>
		               <!--  <tr>
		                  	<th colspan="3">Commission Amount (Direct Sell) </th><td><?=$dirAmt;?></td>
		                </tr> -->
		                <tr class="bg-danger">
		                  	<th colspan="3">Net Commission</th><th> &#8377; <?=$net=$comm_total-$comm_total*11/100+$ex_comm_total;?></th>
		                </tr>
		                <tr>
