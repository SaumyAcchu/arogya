...
<html lang="en">
<head>
    <title><?=$page['page']='Total Sail Report';?> | <?=$this->siteInfo['name'];?></title>
  ...
  <!-- ///=====================All Contents Start Here============= //-->
            <div class="col-sm-12">
              ...
              <div class="col-lg-10 col-lg-offset-1">
                <?= form_open('real1/totalpaymentReport',['class'=>'form-horizontal']); ?>
                <input type="hidden" value="All" name="building_id">
