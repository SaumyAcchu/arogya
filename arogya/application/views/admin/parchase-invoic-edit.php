                ...
                <div class="row padding-top">
                    <div class="container-fluid padding-top main-container">
                        ...
                        <div class="container-fluid padding-top main-container">
                           ...
                           <div class="panel-body">
                               <?=form_open('auth/invoceSlipeditupdate/'.$result['id']); ?>
                             <input type="hidden" value="<?=$result['id'];?>" id="supplier_name" class="form-control" readonly="">
         <input type="hidden" value="<?=$result['supplier_id'];?>" name="supplier_id" class="form-control" readonly="">
          <input type="hidden" value="<?=$result['invoiceno'];?>" name="invoiceno" class="form-control" readonly="">
          <input type="hidden" value="<?=$result['date'];?>" name="date" class="form-control" readonly="">
        
            <?php $product=$this->dbm->getWhere('product',['id'=>$result['product_id']]); ?>
                                       
                                       <div class="col-md-4"><label>Product Name</label>
                                           <input type="text" value=" <?=$product['name'];?>" name="product_id" class="form-control" readonly="">
                                              
                                        </div>

                                          <div class="col-md-4"><label>branch Nb</label>
                                           <input type="text" value=" <?=$result['batch_no'];?>" name="batch_no" class="form-control" readonly="">
                                              
                                        </div>
                                         <div class="col-md-4"><label>QTY </label>
                                           <input type="text" value=" <?=$result['product_qty'];?>" name="product_qty" class="form-control" readonly="">
                                              
                                        </div>

                                        <div class="col-md-4">
                                          <label>Product Hsn</label>
                                           <input type="text" value="<?=$result['product_hsn'];?>" name="product_hsn"  class="form-control" >
                                              
                                        </div>
                                              <div class="col-md-4">
                                          <label>Total Price</label>
                                           <input type="text" value="<?=$result['total_price'];?>" name="total_price" class="form-control" >
                                              
                                        </div>
                                <div class="col-md-4">
                                          <label>Product Igst</label>
                                           <input type="text" value="<?=$result['product_igst'];?>"  name="product_igst" class="form-control" >
                                              
                                        </div>
   <div class="col-md-4">
                                          <label>Product Sgst</label>
                                           <input type="text" value="<?=$result['product_sgst'];?>" name="product_sgst" class="form-control" >
                                              
                                        </div>

                                           <div class="col-md-4">
                                          <label>Product Cgst</label>
                                           <input type="text" value="<?=$result['product_cgst'];?>"  name="product_cgst" class="form-control" >
