        ...
        <div class="col-sm-12">
          <table class="table table-hover table-bordered table-striped table-condensed">
                <tbody>
                  ...
                  <tr>
                    <th colspan="5" style="text-align: right;">PLC</th><th style="color: red; text-align: right;">&#8377; <?=number_format($plcchar=intval($get_data['plc']));?></th>
                  </tr>
                  <tr><?php $devcharg=$get_data['dev_charg']; ?>
                    <th colspan="5" style="text-align: right;">Dev</th><th style="color: red; text-align: right;">&#8377; <?=$devcharg;?></th>
                  </tr>
                  <tr>
                    <th colspan="5" style="text-align: right;">Payed Booking Amount</th><th style="color: red; text-align: right;">&#8377; <?=$get_data['booking_amount'];?></th>
                  </tr>
                  ...
                  <tr>
                    <th colspan="5" style="text-align: right;">Net Payable Amount</th><th style="color: red; text-align: right;">&#8377; <?=$digit=intval($flat['total'])+intval($plcchar)+intval($devcharg)-intval($get_data['discount'])-intval($get_data['booking_amount']);?></th>
                  </tr>
          ...
          <table class="table table-hover table-bordered table-striped table-condensed">
                <tbody>
                  ...
                  <?php $data=$this->db_model->globalSelect('installment',['flat_user_id'=>$get_data['id'],'flat_id'=>$flat['id']]);
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if($payData['status']==0){ ?>
                        <a href="<?=base_url('control/getData/installment/'.$payData['id'].'/pay-installment');?>" class="btn btn-sm btn-primary"> Pay </a>
                      ...
                      <?php } else {
                        ...
                        <a href="<?=base_url('real1/printInvoice/'.$pay_id['id']);?>" class="btn btn-sm btn-warning"> Print <i class="fa fa-print"></i></a>
                      <?php } ?>
                      </div>
                    </td>
                  </tr>
