...
<html lang="en">
<head>
  	<title><?=$page['page']='Cancellation Notification Management';?> | <?=$this->siteInfo['name'];?></title>
		                        ...
		                        <?php if($data) { $i=1;
		                         foreach($data as $list) { ?>
		                          <tr>
		                            ...
		                            <td><?=$this->db_model->dmy($list['next_due_date']);?></td>
		                            <td><?=$this->db_model->dmy($list['registration_date']);?></td>
		                            ...
		                            <div class="btn-group">
		                             <?php if($this->logged['access_level']=='universal'){ ?>
		                               <a title="Chang Cancellation" onclick="return conDel('real1/changeCancellation/<?=$list['id'];?>');" href="#" class="btn btn-sm btn-danger"><span class="fa fa-pencil-square-o"></span></a>
