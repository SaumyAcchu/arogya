...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  	<title><?=$page['page']='Manage History';?> | <?=$this->siteInfo['name'];?></title>
          ...
          <?php if(isset($pairMatch)){ ?>
              ...
              <table id="table2" class="table table-condensed table-bordered table-striped table-hover">
                ...
                foreach ($pairMatch as $key => $value) { ?>
                      <tr>
                        ...
                        <td><?=$value['paidAmt'];
                        $bonus=$bonus+$value['paidAmt']; ?></td>
                        <td><?=$value['paidAmt']/.9;?></td>
                      </tr>
                <?php $i++; } ?>
                </tbody>
              </table>
            ...
            <div class="col-md-6 col-md-offset-3 well">
              <table class="table table-condensed table-hover table-bordered table-striped">
                ...
                <tr>
                  <td>Total Income</td><td class="txtright"><?=$bonus;?></td>
                </tr>
                <tr style="background: lavender;">
                  <th>Total</th><th class="txtright"><?=number_format($to=$bonus+$dir+$droi,2); ?></th>
                </tr>
                <tr>
