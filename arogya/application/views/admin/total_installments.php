  ...
  <!-- ///=====================All Contents Start Here============= //-->
   <?php $digit=0; ?>
            ...
            <div class=" col-lg-12" id="myDiv">
              <table class="table table-hover table-bordered table-striped" border="1" cellpadding="5" style="width:100%; margin-bottom: 3px;">
                <tbody>
                  <tr rowspan="2">
                    <th><center><img src="<?=base_url('uploads/'.$this->siteInfo['image']);?>" height="90" width="90"></center></th>
                    <td class="txtcenter" colspan="5">
                      <h3 style=" margin-top: 0px;"><?=$this->siteInfo['name'];?></h3>
                      <b><?=$this->siteInfo['address'];?></b>
                      <span>Email : <?=$this->siteInfo['email'];?>, Website : <?=$this->siteInfo['website'];?></span>
                      <p style="    margin: 0 0 0px;">Payment Summary</p>
                    </td>
                  </tr>
                  <tr>
    ...
    margin-bottom: 0px">PAYMENT SUMMARY</h4>
              <table class="table table-hover table-bordered table-striped" border="1" cellpadding="5" style="width:100%;">
                <tbody>
                  ...
                  <?php $paid=0; $amt=$g_total; $i=1; foreach($payment as $payData) { ?>
                  <tr>
                    <td><?=$payData['trnx'];?></td>
