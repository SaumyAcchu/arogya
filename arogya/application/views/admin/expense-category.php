	      	...
	      	<div class="container-fluid">
		        ...
		        <div class="row padding-top">
					...
					<div class="col-lg-6 col-lg-offset-3" style="padding: 10px; box-shadow: 0px 1px 10px 1px #33A5E7; margin-top: 10px;">
						<?= form_open('auth/updateData/expense_category/'.$get_data['id'].'/expense-category',['class'=>'form-horizontal']); ?>
				...
				<?php } ?>
				<div class="col-lg-6 col-lg-offset-3" style="padding: 10px; box-shadow: 0px 1px 10px 1px #33A5E7; margin-top: 10px;">
					<?= form_open('auth/insertData/expense_category/expense-category',['class'=>'form-horizontal']); ?>
						...
						<table class="table table-striped table-hover table-bordered">
						  ...
						  <?php $i=1; foreach($data as $value): ?>
						    <tr>
						      ...
						      <td>
						      	<div class="btn-group">
						      		<a href="<?= base_url('auth/getData/expense_category/'.$value['id'].'/expense-category'); ?>" class="btn btn-info btn-sm"> Edit </a>
						     		<a onclick="return confirm('Are you sure to Delete.')" href="<?= base_url('auth/deleteData/expense_category/'.$value['id'].'/expense-category'); ?>" class="btn btn-danger btn-sm">Delete</a>
						     	</div>
						      </td>
						    </tr>
						  <?php $i++; endforeach; ?>
