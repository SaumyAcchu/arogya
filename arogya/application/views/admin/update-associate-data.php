...
<html lang="en">
<head>
    <title><?=$page['page']='Associate Updates';?> | <?=$this->siteInfo['name'];?></title>
...
<body>
  ...
  <!-- ///=====================All Contents Start Here============= //-->
      ...
      <div class="jumbotron">
     <?= form_open_multipart('real1/associatManagement/upd/'.$user['id'],['class'=>'form-horizontal']); ?>
        ...
        <legend style="margin-top: 10px;">Edit Associate Detail</legend>
        <div class="form-group">
