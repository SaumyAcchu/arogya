	      	...
	      	<div class="container-fluid">
		        ...
		        <div class="row padding-top">
					...
					<div class="col-lg-6 col-lg-offset-3 jumbotron">
						...
						<?=form_open_multipart('auth/updateDataWithFile/company/'.$get_data['id'].'/company-management',['class'=>'form-horizontal']); ?>
							...
							<div class="form-group">
								<label>GST No :</label>
								<input type="text" name="gstNo" class="form-control" value="<?=$get_data['gstNo'];?>" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>PIN Generation Amount :</label>
								<input type="text" name="pin_amt" class="form-control" value="<?=$get_data['pin_amt'];?>" required>
							</div>
							<div class="form-group">
								<label>Base Business Amount :</label>
								<input type="text" name="business" class="form-control" value="<?=$get_data['business'];?>" required>
							</div>
							<div class="form-group">
								<div class="col-lg-8">
									<div class="form-group">
					...
					<div class="col-lg-8 col-lg-offset-2 jumbotron">
						<table class="table table-bordered table-striped table-hover">
							...
							<tr>
								...
								<td><a href="<?=base_url('auth/getData/company/'.$value['id'].'/company-management');?>" class="btn btn-sm btn-primary">Edit</a></td>
							</tr>
							<tr>
							...
							<tr>
								<th>GST No.</th><td><?=$value['gstNo'];?></td>
							</tr>
							<tr>
							...
							<tr>
								<th>PIN Amount</th><td><?=$value['pin_amt'];?></td>
							</tr>
							<tr>
								<th>Business Amount</th><td><?=$value['business'];?></td>
							</tr>
							<?php } ?>
						</table>
					</div>
