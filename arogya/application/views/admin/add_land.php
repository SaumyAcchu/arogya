            ...
            <div class="row padding-top">
                ...
                <!-- ///=====================All Contents Start Here============= //-->
                           <?= form_open('real1/landMgmt/add',['class'=>'form-horizontal jumbotron']); ?>
                              ...
                              <div class="form-group">
                                <label class="col-sm-2 control-label">Area in Bigha</label>
                                <div class="col-sm-4">
                                  <input type="text" onchange="return mainCal();" value="<?= set_value('area'); ?>" name="area" class="form-control" id="area" placeholder="Enter Land Area in Bigha" required>
                                  <span style="color: red;" id="errArea"></span>
                                </div>
                                <label class="col-sm-2 control-label">Rate Per Bigha</label>
                                <div class="col-sm-4">
                                  <input type="number" onchange="return mainCal();" value="<?= set_value('rate'); ?>" name="rate" class="form-control" placeholder="Enter Land Rate per Bigha" id="rate" required>
