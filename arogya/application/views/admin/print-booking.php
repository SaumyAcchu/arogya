...
<html lang="en">
<head>
  <title><?=$page['page']='Booking Slip';?> | <?=$this->siteInfo['name'];?></title>
            ...
            <div class="row padding-top">
              ...
              <div class="col-sm-12" id="myDiv">
                            <table class="table table-bordered" cellpadding="4" style="width: 100%;" border="1">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Invoice No.  <b><?= $bookingreslt['id'] ?></b>
                                  </td>
                                  <td>
                           ...
                           <table class="table table-bordered" style="width: 100%;" border="1" cellpadding="5">
                              <tbody>
                                <tr class="danger">
                                  <th>Product Name</th><th>Mrp</th><th>Qty</th><th>PV</th><th>Total PV</th><th>Total BV</th>
                                </tr>
