...
<html>
<head>
  <title>Please Login | <?=$this->siteInfo['name']; ?></title>
...
<div class="container">
    <div class="row">
        ...
        <h3 class="heading-desc">Employee Login to Continue...</h3>
        <div class="social-box">
            <div class="row mg-btm">
             <div class="col-md-12">
                <center><img src="<?=base_url('uploads/'.$this->siteInfo['image']);?>" class="img-thumbnail logo-img"></center>
            </div>
            </div>
            <h4 class="text-center">Welcome to <?=$this->siteInfo['name'];?></h4>
        </div>
        <?=form_open('login/employeeLogin'); ?>
        <div class="main">
          <!-- ///Flash Message Start/// -->
 ...
 <div class="dropdown-menu" style="
    width: 100%;">
    <a class="dropdown-item" href="<?=base_url('login');?>" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Admin Login</a><br>
    
    <a class="dropdown-item" href="<?=base_url('login/associteLogin');?>" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Associate Login</a><br>
    
    <a class="dropdown-item" href="<?=base_url();?>index.php/login/customer" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Customer Login</a><br>
    
     <a class="dropdown-item" href="<?=base_url();?>index.php/login/AccountLogin" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Account Login</a><br>
    <a class="dropdown-item" href="<?=base_url();?>index.php/login/hrLogin" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">HR Login</a><br>
    <a class="dropdown-item" href="<?=base_url();?>index.php/login/employee" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Employee Login</a><br>
     <a class="dropdown-item" href="<?=base_url();?>index.php/login/landOwner" style="padding-left: 8px;
    font-weight: 600;    text-align: justify;">Land Owner Login</a>
  </div>
</div>
                              </div>
        <div class="form-group">
            <div class="input-group">
              ...
              <input type="text" name="user_id" class="form-control txtupper" placeholder="Employee Id" aria-label="Employee Id" value="<?=set_value('user_id');?>" aria-describedby="basic-addon1" autofocus="" required="">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
        ...
        <div class="form-group">
            ...
            <!-- <span class="pull-right" style="line-height: 30px;">New User : <a href="<?=base_url('login/registrationpage');?>"> Register</a></span> -->
        </div>         
