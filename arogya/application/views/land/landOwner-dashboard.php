...
<html lang="en">
<head>
  	<title><?=$page['page']='Welcome to Customers Dashboard';?> | <?=$this->siteInfo['name'];?></title>
                    ...
                    <div class="circle-tile ">
                        <a href="#"><div class="circle-tile-heading dark-blue" id="head-tile"><i class="fa fa-black-tie fa-fw fa-3x"></i></div></a>
                        	<div class="circle-tile-content dark-blue">
	                            ...
	                            <div class="circle-tile-number text-faded "><?=$this->loggedLand['owner_name']?></div>
	                        	<a class="circle-tile-footer" href="<?=base_url('land/profile');?>">More Info <i class="fa fa-chevron-circle-right"></i></a>
                        	</div>
                    </div>
                </div>
		                        ...
		                        <div class="panel-heading">
			                        <div class="row">
			                        	<div class="col-xs-4">
			                          	...
			                          	<!-- <?=$this->logged['name']?> -->
			                          	<a href="<?=base_url('land/customerInformation');?>">
			                          	<div class="col-xs-8 text-right">
			                            	<h3 class="announcement-text">Total Payed</h3>
			                            	<p class="announcement-heading">&#8377; <?=number_format($payment) ?> </p>
			                          	</div>
			                          	</a>
			                        </div>
		                        </div>
		                        <a href="<?=base_url('land/installmentStatus');?>">
