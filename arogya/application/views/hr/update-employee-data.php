...
<html lang="en">
<head>
    <title><?=$page['page']='Employee Updates';?> | <?=$this->siteInfo['name'];?></title>
...
<body>
  ...
  <!-- ///=====================All Contents Start Here============= //-->
      ...
      <div class="jumbotron">
     <?= form_open_multipart('hr/empManagement/upd/'.$user['id'],['class'=>'form-horizontal']); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" value="<?=$user['sponcer_id']; ?>" name="sponcer_id" class="form-control txtupper noSpace" id="sponcer_id" placeholder="Enter Sponcer ID" required>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Sponcer ID<span>*</span></label>
            <div class="col-sm-4">
                <input type="text" onchange="return countSponcer()" value="<?=$user['sponcer_id']; ?>" name="sponcer_id" class="form-control txtupper noSpace" id="sponcer_id" placeholder="Enter Sponcer ID" required>
                <span id="err_sponcer"></span>
            </div>
            <label class="col-sm-2 control-label">Sponcer Name</label>
            <div class="col-sm-4">
        ...
        <legend style="margin-top: 10px;">Edit Employee Detail</legend>
        <div class="form-group">
            <label class="col-sm-2 control-label">Name<span>*</span></label>
            <div class="col-sm-3">
                <input type="text" value="<?=$user['name']; ?>" name="name" class="form-control" id="name" placeholder="Enter Applicants First Name" required>
                <span id="err_name"></span>
            </div>
            <div class="col-sm-3">
                <input type="text" value="<?=$user['m_name']; ?>" name="m_name" class="form-control" id="m_name" placeholder="Enter Applicants Middle Name">
                <span id="err_mname"></span>
            </div>
            <div class="col-sm-3">
                <input type="text" value="<?=$user['l_name']; ?>" name="l_name" class="form-control" id="l_name" placeholder="Enter Applicants Last Name" >
        ...
        <div class="form-group">
           <label class="col-sm-2 control-label">Father/Husband Name</label>
            <div class="col-sm-4">
                <input type="text" value="<?=$user['fname']; ?>" name="fname" class="form-control" id="fname" placeholder="Enter Father/Husband Name">
          ...
          <label class="col-sm-2 control-label">Date of Birth</label>
            <div class="col-sm-4">
                <span id="datepairExample">
                  <input type="text" value="<?=$user['dob']; ?>" name="dob" class="form-control date" id="datepicker" placeholder="dd-mm-yyyy" required>
                </span>
            </div>
        ...
        <div class="form-group">
           <label class="col-sm-2 control-label">Designation</label>
            <div class="col-sm-4">
                <input type="text" value="<?=$user['designation']; ?>" name="designation" class="form-control" id="designation" placeholder="Enter Designation">
                <span id="err_designation"></span>
            </div>

          <label class="col-sm-2 control-label">IPF No.</label>
            <div class="col-sm-4">
                <input type="text" value="<?=$user['ipf']; ?>" name="ipf" class="form-control" id="ipf" placeholder="Enter IPF No.">
                <span id="err_ipf"></span>
            </div>
       ...
       <!--  <div class="form-group">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Email Id</label>
            <div class="col-sm-4">
                <input type="email" value="<?=$user['email']; ?>" class="form-control noSpace" name="email" id="email" placeholder="Email ID">
                <span id="err_email"></span>
            </div>
            <!-- <label class="col-sm-2 control-label">Address</label>
            <div class="col-sm-4">
                <textarea class="form-control" value="" name="address" rows="2" id="address" placeholder="Enter Your Adderss"><?=$user['address']; ?></textarea>
            </div> -->
        </div>
        ...
        <div class="form-group">
         <label class="col-sm-2 control-label">Address</label>
         <div class="col-sm-4">
             <input type="text" value="<?=$user['location']; ?>" class="form-control" name="location" placeholder="Location" required>
               <span id="err_city"></span>
         </div>

          <label class="col-sm-2 control-label">City</label>
           <div class="col-sm-4">
               <input type="text" value="<?=$user['city']; ?>" class="form-control noSpace" name="city" id="city" placeholder="City Name" required>
               <span id="err_city"></span>
           </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
               <input type="text" value="<?=$user['state']; ?>" class="form-control" name="state" id="state" placeholder="Enter State" required>
               <span id="err_state"></span>
           </div>

          <label class="col-sm-2 control-label">Pin Number<span>*</span></label>
           <div class="col-sm-4">
               <input type="text" maxlength="6" value="<?=$user['pin']; ?>" class="form-control noSpace" name="pin" id="pin" placeholder="Pin No.">
               <span id="err_city"></span>
           </div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Mobile Number<span>*</span></label>
            <div class="col-sm-4">
                <input type="number" maxlength="10" value="<?=$user['mobile']; ?>" class="form-control" name="mobile" id="mobile" placeholder="Mobile Number" required>
       ...
       <!--  <legend>Nomini Detail's</legend>
        <div class="form-group">
          <div class="col-sm-4">
            ...
            <input type="text" name="nomini_name" value="<?=$user['nomini_name']; ?>" class="form-control" id="nomini_name" placeholder="Nomini Name">
          </div>
          <div class="col-sm-4">
            <label>Nomini Relation</label>
            <input type="text" name="nomini_rel" value="<?=$user['nomini_rel']; ?>" class="form-control" id="nomini_rel" placeholder="Nomini Relation">
          </div>
          <div class="col-sm-4">
            <label>Nomini Age</label>
            <input type="number" name="nomini_age" value="<?=$user['nomini_age']; ?>" class="form-control" id="nomini_age" placeholder="Nomini Age">
          </div>
        </div>
 -->
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Adhar No.</label>
            <div class="col-sm-4">
              <input type="number" name="adhar" value="<?=$user['adhar']; ?>" class="form-control noSpace" id="adhar" placeholder="ADHAR Number">
            </div>
 ...
 <div class="form-group">
     ...
     <div class="col-lg-4">
      ...
      <img src="<?=base_url('uploads/'.$user['image']);?>" style="" id="blah" height="100" width="100">
     </div>
 </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" name="account_number" value="<?=$user['account_number']; ?>" class="form-control" id="account_number" placeholder="A/C Number">
            </div>
            <label class="col-sm-2 control-label">Bank Name</label>
            <div class="col-sm-4">
              <input type="text" value="<?=$user['bank_name']; ?>" name="bank_name" class="form-control" placeholder="Enter Bank Name">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">Branch Name</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" name="branch_name" id="branch_name" value="<?=$user['branch_name']; ?>" placeholder="Branch name">
            </div>
            <label class="col-sm-2 control-label">IFSC Code</label>
            <div class="col-sm-4">
              <input type="text" value="<?=$user['ifsc']; ?>" name="ifsc" class="form-control" id="ifsc" placeholder="IFSC Code">
            </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    function countSponcer(){
      ...
      $.ajax({
        url:"<?=base_url('control/countSponcer');?>",
        type:'post',
        data:{id:sponcerID},
    ...
    function checkValid()
    {
      ...
      if((mobile.length)>10)
      {
        $('#err_mobile').html('Mobile Number Must be Equal 10 Characters');
        return false;
      }
      /*if((pass.length)<6)
      {
  ...
  <script type="text/javascript">
    ...
    if(chkd=='yes')
    {
      $('#emiMonth').html('<label class="col-sm-4 control-label">PAN Number</label><div class="col-sm-8"><input type="text" name="pan" value="<?=$user['pan']; ?>" class="form-control noSpace" id="pan" placeholder="PAN Number" required><span id="err_pan"></span></div>');
    }else
    {
      $('#emiMonth').html('');
    }
