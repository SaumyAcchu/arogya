...
<html lang="en">
<head>
    <title><?=$page['page']='Employee Registration';?> | <?=$this->siteInfo['name'];?></title>
...
<body>
  ...
  <!-- ///=====================All Contents Start Here============= //-->
      ...
      <div class="jumbotron">
      <?= form_open_multipart('hr/registration/sub',['class'=>'form-horizontal','name'=>'myform','id'=>'regForm']); ?>
      
      <legend>Departments Details</legend>
        <b>Note: </b><label class="txtblue"><span>*</span> Fields are required.</label>
        <div class="form-group">
            <label class="col-sm-2 control-label">Select Departments<span>*</span></label>
            <div class="col-sm-4">
              <?php $depart = $this->dbm->getData('departments'); ?>
                <select class="form-control" required="" name="department_id" required="required">
            ...
            <label class="col-sm-2 control-label">Salary<span>*monthly</span></label>
            <div class="col-sm-4">
                <input type="number" onchange="" value="" name="salary" class="form-control txtupper noSpace"  placeholder="Enter Salary in monthly" required>
        ...
        <!-- <input type="hidden" name="access_level" value="limited"> -->
        <legend style="margin-top: 10px;">Employee Details</legend>
        <div class="form-group">
            <label class="col-sm-2 control-label">Name<span>*</span></label>
            <div class="col-sm-3">
                <input type="text" value="<?= set_value('name'); ?>" name="name" class="form-control" id="name" placeholder="Enter Employee First Name" required>
                <span id="err_name"></span>
            </div>
            <div class="col-sm-3">
                <input type="text" value="<?= set_value('m_name'); ?>" name="m_name" class="form-control" id="m_name" placeholder="Enter Employee Middle Name">
                <span id="err_mname"></span>
            </div>
            <div class="col-sm-3">
                <input type="text" value="<?= set_value('l_name'); ?>" name="l_name" class="form-control" id="l_name" placeholder="Enter Employee Last Name" >
        ...
        <div class="form-group">
           <label class="col-sm-2 control-label">Designation</label>
            <div class="col-sm-4">
                <input type="text" value="<?= set_value('designation'); ?>" name="designation" class="form-control" id="designation" placeholder="Enter Designation">
                <span id="err_designation"></span>
            </div>

          <label class="col-sm-2 control-label">IPF No.</label>
            <div class="col-sm-4">
                <input type="text" value="<?= set_value('ipf'); ?>" name="ipf" class="form-control" id="ipf" placeholder="Enter IPF No.">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Email Id</label>
            ...
            <div class="col-sm-4">
                <input type="text" maxlength="10" value="<?= set_value('mobile'); ?>" class="form-control" name="mobile" id="mobile" placeholder="Mobile Number" required>
       ...
       <!--  <legend>Nomini Details</legend>
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="number" name="nomini_age" value="<?= set_value('nomini_age'); ?>" class="form-control" id="nomini_age" placeholder="Nomini Age">
          </div>
        </div> -->
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Adhar No.</label>
            <div class="col-sm-4">
              <input type="text" maxlength="12" name="adhar" value="<?= set_value('adhar'); ?>" class="form-control noSpace" id="adhar" placeholder="ADHAR Number">
            </div>           
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
                ...
                <button type="submit" onclick="" id="submit" class="btn btn-primary">Submit</button>
            </div>
        </div>
        </form>
      </div>
  ...
  <script type="text/javascript">
    ...
    if(chkd=='yes')
    {
      $('#emiMonth').html('<label class="col-sm-4 control-label">PAN Number</label><div class="col-sm-8"><input type="text" maxlength="10" name="pan" value="<?= set_value('pan'); ?>" class="form-control noSpace" id="pan" placeholder="PAN Number" required><span id="err_pan"></span></div>');
    }else
    {
      $('#emiMonth').html('');
    }
