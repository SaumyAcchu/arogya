      <div class="left-sidebar" id="show-nav">
        <ul id="side" class="side-nav">
          <li class="panel">
            <a href="<?=base_url('customer');?>"> <i class="fa fa-dashboard"></i> Dashboard</a>
          </li>
          <li class="panel">
            <a href="<?=base_url('customer/profile');?>"> <i class="fa fa-user"></i> My Profile</a>
          </li>

          <li class="panel">
            <a href="<?=base_url('customer/installmentStatus');?>"> <i class="fa fa-money"></i> Installment Status</a>
          </li>
          <li class="panel">
            <a href="<?=base_url('customer/customerInformation');?>"> <i class="fa fa-cc-mastercard"></i> Payment History</a>
          </li>
          ...
          <li class="panel">
            <a id="" href="<?=base_url('customer/changePassword');?>">
              <i class="fa fa-user-secret"></i> Change Password</a>
          </li>
          <li class="panel">
            <a id="" href="<?=base_url('login/logoutCust'); ?>" >
