                ...
                <tbody>
                 ...
                 <!-- <?php if($userData['discount']>=0) { ?>-->
                  ...
                  <tr>
                    ...
                    <td class="txtright"><b style="color: red;"><?php $netpay = number_format($digit=$flat['total']+$plccharg+$devcharg-$userData['discount']-intval($userData['specialdiscount']));?> &#8377; <?=($netpay!='')?$netpay.".00":"0.00"; ?></b></td>
                  </tr>
                 <!-- <?php } ?>-->
                  <tr>
