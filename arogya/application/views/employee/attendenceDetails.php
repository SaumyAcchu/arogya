  	...
  	<div class="wrapper" id="wrapper">
	    ...
	    <div class="right-container" id="right-container">
	      	<div class="container-fluid">
                ...
                <?= form_open('employee/attendance',['class'=>'form-horizontal']); ?>
        ...
        <div class="col-sm-12" id="myDiv">
            ...
            <b style="color:red;"> From </b>: <b style="color:green;"><?=$searchFor['dateTo'];?></b> &nbsp;&nbsp;&nbsp;
            <b style="color:red;"> To </b>: <b style="color:green;"><?=$searchFor['dateFrom'];?></b> &nbsp;&nbsp;&nbsp;
            ...
            <table id="example" class="table table-striped table-hover table-bordered display" border="1" cellpadding="5" style="width:100%;">
              ...
              <?php $i=1; $total=0; if(count($salaryReport)>0){ foreach($salaryReport as $list){ ?>
                ...
                <?php $i++; } ?>
               <!--  <tr>
                  <th colspan="5">Total</th><th>&#8377; <?php $amtunt=intval($total); echo $amtunt;?>/-</th>
                </tr> -->
