      <div class="left-sidebar" id="show-nav">
        <ul id="side" class="side-nav">
          ...
          <li class="panel">
            <a href="<?=base_url('employee/attendance');?>"> <i class="fa fa-money"></i> Chek Attendance</a>
          </li>
          <li class="panel">
            <a href="<?=base_url('employee/salary');?>"> <i class="fa fa-cc-mastercard"></i> Salary Details</a>
          </li>
          ...
          <li class="panel">
            <a id="" href="<?=base_url('employee/changePassword');?>">
