    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <center><img src="<?=base_url('uploads/'.$this->siteInfo['image']); ?>" height="150" width="150"></center><br>
          <center>
          <h4><?=$this->siteInfo['name'];?></h4>
        ...
        <div class="modal-body">
              ...
              <?php endif; ?>
            <?php echo form_open('login/forgetPasswordVerification',['class'=>'form-horizontal','onsubmit'=>'return checkPass();']); ?>
                <div class="form-group">
                  <div class="col-lg-12">
