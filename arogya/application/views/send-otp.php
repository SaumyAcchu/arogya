...
<html lang="en">
<head>
  	<title><?=$page['page']='Forget Password';?> | <?=$this->siteInfo['name'];?></title>
  	...
  	<div class="wrapper" id="wrapper">
            ...
            <div class="panel-body">
              ...
              <div class="col-lg-6 col-lg-offset-3 jumbotron txtcenter">
                <span>To open this page OTP Authentication is Required.</span>
                <div class="row form-horizontal" style="padding: 10px;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-7">
                      <b><u><?=substr($_SESSION['mobile'],0,4)."XXXX".substr($_SESSION['mobile'],8, 10);?></u></b>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-7">
                      <center><button type="submit" id="" class="btn btn-primary"> Validate </button> <br><br>
                        <!-- <a class="txtblue" href="<?=base_url('login');?>"> <u>Re-send OTP</u> </a> -->
                      </center>
                    </div>
                  </div>
                  </form>
