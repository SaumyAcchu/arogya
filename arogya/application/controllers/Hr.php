...
class Hr extends MY_Controller {
	...
	public function registration($param1='',$param2='')
	{
		if($param1=='sub')
		{
			...
			// 	$data['daySalary'] = intval($_POST['salary'])/28;
			//   }else{
			// 	$data['daySalary'] = 0;	
			// }
			...
			if($res)
			{
				...
				if($tomail['mobile']=='')
					...
					{
						 	$msg="Dear ".$tomail['name']." Registration Successful, Your User ID ".$tomail['employee_id']." and Password is : ".$tomail['password']." http://prayasinfra.com/Software/employee";
