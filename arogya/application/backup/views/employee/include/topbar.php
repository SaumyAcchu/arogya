    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-right" id="myNavbar">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><?=$this->loggedEmp['name'];?>          
           <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="txtcenter"><?=$this->loggedEmp['employee_id'];?></li>
             <!--  <li class="txtcenter"> <a href="<?=base_url('user/explore/my-profile');?>"><i class="fa fa-user"></i> Profile</a> </li> -->
              <li class="txtcenter"> <a href="<?=base_url('login/logoutEmp');?>"><i class="fa fa-power-off"></i> Logout</a> </li>
            </ul>
          </li>
        </ul>
      </div>
