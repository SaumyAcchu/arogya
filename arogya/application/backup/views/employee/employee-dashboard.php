...
<html lang="en">
<head>
  	<title><?=$page['page']='Welcome to Employee Dashboard';?> | <?=$this->siteInfo['name'];?></title>
                    ...
                    <div class="circle-tile ">
                        <a href="#"><div class="circle-tile-heading <?=$color;?>" id="head-tile"><i class="fa <?=$fa;?> fa-fw fa-3x"></i></div></a>
                        	<div class="circle-tile-content <?=$color;?>">
                            	<div class="circle-tile-description text-faded">Attendance</div>
	                            <div class="circle-tile-number text-faded "><?=$status;?></div>
	                        	<a class="circle-tile-footer" href="<?=base_url('employee/attendance');?>">More Info <i class="fa fa-chevron-circle-right"></i></a>
                        	</div>
                    </div>
                </div>
				<div class="col-lg-4 col-xs-6">
                    <div class="circle-tile ">
                        <a href="#"><div class="circle-tile-heading dark-blue" id="head-tile"><i class="fa fa-black-tie fa-fw fa-3x"></i></div></a>
                        	<div class="circle-tile-content dark-blue">
                            	<div class="circle-tile-description text-faded"> Salary </div>
	                            <div class="circle-tile-number text-faded "><?=$this->loggedEmp['name']?></div>
	                        	<a class="circle-tile-footer" href="<?=base_url('employee/salary');?>">More Info <i class="fa fa-chevron-circle-right"></i></a>
                        	</div>
                    </div>
                </div>
