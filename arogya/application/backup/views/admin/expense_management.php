	      	...
	      	<div class="container-fluid">
		        ...
		        <div class="row padding-top">
					...
					<div class="col-lg-6 col-lg-offset-3" style="padding: 10px; box-shadow: 0px 1px 10px 1px #33A5E7; margin-top: 10px;">
						<?= form_open('real1/expenseManagement/add',['class'=>'form-horizontal']); ?>
							  ...
							  <?php $i=1; foreach($data as $expenseReport): ?>
							    <tr>
							      ...
							      <td>
							      	...
							      	<a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete.')" href="<?= base_url('control/deleteData/expense_entry/'.$expenseReport['id'].'/expense_management'); ?>"><span class="glyphicon glyphicon-trash"></span></a> 
							      </td>
							    </tr>
							   <?php $i++; endforeach; ?>
							   <?php } else { ?>
