...
<html lang="en">
<head>
    <title><?=$page['page']='Add Site';?> | <?=$this->siteInfo['name'];?></title>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <p class="panel-title">Sites Management</p>
                                </div>
                                <div class="panel-body">
                                    <div class="col-lg-4">
                                        <?php if(isset($get_data)) { ?>
                                        <center>
                                            <h4>Update Sites Type</h4>
                                        </center>
                                        <?=form_open('auth/updateAndReturn/sites/'.base64_encode('real1/explore/add-site')); ?>
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea id="address" class="form-control" name="address"><?=$get_data['address'];?></textarea>
                                        ...
                                        <?=form_open('auth/insertAndReturn/sites/'.base64_encode('real1/exploreData/sites/add-site')); ?>
                                        <div class="form-group">
                                            <label>Name</label>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <table class="table table-striped table-hover table-bordered">
                                            ...
                                            <tbody>
                                                <?php $data = $this->dbm->getData('sites');
                                                if(isset($data)) { $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                            <a title="Edit" href="<?=base_url('control/getData/sites/'.$list['id'].'/add-site');?>" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
                                                            
                                                            <?php  $projects = $this->db_model->rowCount('project',['site_id'=>$list['id']]); /*print_r($projects);*/ ?>
                                                            <?php if ($projects == 0): ?>
                                                            <a onclick="return conDel('real1/siteMgmt/del/<?=$list['id'];?>');" title="Delete" href="#" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
