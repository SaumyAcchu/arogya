...
<html lang="en">
<head>
    <title><?=$page['page']='Registration Successful';?> | <?=$this->siteInfo['name'];?></title>
          ...
          <div class="container-fluid">
            ...
            <!-- ///=====================All Contents Start Here============= //-->
                    ...
                    <table class="table table-bordered table-hover table-striped" border="1" cellpadding="5" width="100%">
                      <tr rowspan="2">
                                  <th><center><img src="<?=base_url('uploads/'.$this->siteInfo['image']);?>" height="80" width="120"></center></th>
                      ...
                      <tr>
                        <td>Name</td><td><?=$data['name'];?>&nbsp;<?=$data['m_name'];?>&nbsp;<?=$data['l_name'];?></td>
