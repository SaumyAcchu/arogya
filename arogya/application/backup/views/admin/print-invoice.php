  ...
  <!-- ///=====================All Contents Start Here============= //-->
            ...
            <div class="col-sm-12" id="myDiv">
              <table class="table table-bordered" cellpadding="4" style="width: 100%;" border="1">
                <tbody>
                  ...
                  <tr>
                    <th>Project Name</th><td colspan="3">  <?=$sitesd['name'];?></td>
                 ...
                 <!-- <?php if($userData['discount']>=0) { ?>-->
                  <tr>
                    <td colspan="3" class="txtright">Payed Booking Amount</td>
                    <th class="txtright"><?php $bookingAmt = number_format(intval($userData['booking_amount']));?> &#8377;  <?= ($bookingAmt!='')?$bookingAmt.".00":"0.00" ?></th>
                  </tr>
                  <tr>
                    <td colspan="3" class="txtright">Discount</td>
                    <th class="txtright"><?php $disco = number_format(intval($userData['discount']));?> &#8377;  <?= ($disco!='')?$disco.".00":"0.00" ?></th>
                  </tr>
                  <tr>
                    ...
                    <td class="txtright"><b style="color: red;"><?php $netpay = number_format($digit=intval($flat['total'])+intval($plccharg)+intval($devcharg)-intval($userData['discount'])-intval($userData['booking_amount']));?> &#8377; <?=($netpay!='')?$netpay.".00":"0.00"; ?></b></td>
                  </tr>
                 <!-- <?php } ?>-->
                  <tr>
            ...
            $payval = $this->db_model->globalSelect('payment',['registration'=>$userData['registration'],'id!='=>$payment['id']]);
             ...
             ?>
                  ...
                  <?php endif ?>
                  <tr style="max-height: 100px;max-width: 100px;">
                    <th colspan="6">Total Paid Amount </th><th colspan="2" style="color: #000;">&#8377; <?=(($cal!='')?$cal.".00":"0.00");?></th>
                  </tr>
                  <tr>
                    <th>Amount(In words)</th><td colspan="7"> : <?=$this->db_model->amount($cal);?> </td>
                  </tr>
                  <tr>
                    <td colspan="6">Total Balance Amount </td><td colspan="2" style="color: #000;">&#8377; 
                      
                      <?php $rest=$digit-(int)$cal; ?><?=(($rest!='')?$rest.".00":"0.00");?> </td>
                  </tr>
                  <tr>
