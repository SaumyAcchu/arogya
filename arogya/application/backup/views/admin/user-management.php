		       ...
		       <div class="container-fluid padding-top main-container">
		        ...
		        <div class="panel panel-primary">
		                  <div class="panel-heading">
		                    <span class="panel-title">Select Project Name</span>
		                  </div>
		                  <?php $projects = $this->db_model->selectAll('project'); ?>
		                          ...
		                          <tr>
		                            <td>
		                              <div class="input-group">
		                                 <span class="input-group-addon" id="basic-addon1">Select Project Name</span>
		                              </div>
		                            </td>
		                            <td>
		                              <div class="input-group">
		                          ...
		                          <tr>
		                            ...
		                            <td><div class="btn-group">
		                              ...
		                              <?php if($this->logged['access_level']=='universal'){ ?>
		                                <a title="Edit" onclick="return conDel('real1/userManagement/edt/<?=$list['id'];?>');" href="#" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
