					...
					<div class="row">
					  <?php if(isset($get_data)) { ?>
						<div class="col-lg-6 col-lg-offset-3 jumbotron">
							...
							<?=form_open('control/updateData/notice/'.$get_data['id'].'/notice-management',['class'=>'form-horizontal']); ?>
					  ...
					  <?php } else { ?>
			            				...
			            				<tbody>
			            				  <?php if($data){ $i=1;
			            					...
			            					<tr>
			            						...
			            						<td>
			            							<div class="btn-group">
			            								<a href="<?=base_url('control/getData/notice/'.$value['id'].'/notice-management');?>" class="btn btn-sm btn-primary"> <i class="fa fa-pencil"></i> </a>
			            								<a onclick="return conDel()" href="<?=base_url('control/deleteData/notice/'.$value['id'].'/notice-management');?>" class="btn btn-sm btn-danger"> <i class="fa fa-trash-o"></i> </a>
			            							</div>
			            						</td>
			            					</tr>
			            				  <?php $i++; } } else { ?>
						...
						<div class="col-lg-4 jumbotron">
							...
							<?=form_open('control/insertData/notice/notice-management',['class'=>'form-horizontal']); ?>
								<div class="form-group">
									<label>Date : </label>
