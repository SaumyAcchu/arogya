						    ...
						    <tr>
						      <td>
						        <div class="input-group" id="datepairExample">
						           ...
						           <input type="text" value="" name="dateFrom" class="form-control date" id="datepicker" placeholder="dd-mm-yyyy" required>
						        </div>
						      </td>
						      <td>
						      	<div class="input-group" id="datepairExample">
						           <span class="input-group-addon" id="basic-addon1">To</span>
						           <input type="text" value="" name="dateTo" class="form-control date" id="datepicker" placeholder="dd-mm-yyyy" required>
						        </div>
						      </td>
