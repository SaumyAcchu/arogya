...
<!-- ///=====================All Contents Start Here==========================================/// -->
			<div class="col-sm-12">
				<div class="col-lg-6 jumbotron">
					<center><h4>Have any query? : (Contact Administrator)</h4></center>
				...
				<div class="col-lg-6" id="contain">
					<legend style="margin-top: 10px;">Conversations</legend>
		              <?php if(!empty($data)) { ?>
		                  ...
		                  <div class="chat-history">
		                    <ul class="chat-ul">
		                      ...
		                      <li>
		                        ...
		                        <?=$msg['message']; ?>
		                        <br><i style="font-size: 12px;color: black;"><?=$msg['date']; ?> <?=$msg['time']; ?></i>
		                        </div>
		                      </li>
