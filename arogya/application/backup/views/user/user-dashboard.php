                    ...
                    <div class="circle-tile ">
                        <a href="#"><div class="circle-tile-heading dark-blue" id="head-tile"><i class="fa fa-black-tie fa-fw fa-3x"></i></div></a>
                        	<div class="circle-tile-content dark-blue">
                            	<div class="circle-tile-description text-faded"> Directs </div>
	                            <div class="circle-tile-number text-faded "><?=$this->db_model->rowCount('flat_registration',['introducer'=>$this->logged['user_id']]);?></div>
	           		...
	           		<div class="row">
		                        ...
		                        <div class="panel-heading">
			                        <div class="row">
			                        	<div class="col-xs-4">
			                          	...
			                          	<?php $dir=$this->db_model->rowCount('users',['sponcer_id'=>$this->logged['user_id']]); ?>
			                          	<a href="<?=base_url('user/getAllData/'.base64_encode('users/sponcer_id/'.$this->logged['user_id'].'/direct-joins'));?>">
			                          	<div class="col-xs-8 text-right">
			                            	<h3 class="announcement-text">Direct Joins</h3>
			                            	<p class="announcement-heading">Associates : <?=$dir;?></p>
			                          	</div>
			                          	</a>
			                        </div>
		                        </div>
		                ...
		                <div class="col-sm-6">
		                    <div class="panel panel-danger">
		                        <div class="panel-heading">
		                        	<?php $cus=$this->db_model->rowCount('flat_registration',['introducer'=>$this->logged['user_id']]); ?>
			                        <div class="row">
			                        	<div class="col-xs-4">
			                            	<i class="fa fa-sort-amount-asc fa-5x"></i>
			                          	</div>
			                          	<a href="<?=base_url('user/getAllData/'.base64_encode('flat_registration/introducer/'.$this->logged['user_id'].'/direct-customers'));?>">
			                          	<div class="col-xs-8 text-right">
			                            	<h3 class="announcement-text">Your Clientage</h3>
			                            	<p class="announcement-heading">Customers : <?=$cus; ?></p>
			                          	</div>
			                          	</a>
			                        </div>
		                        </div>
		                        ...
		                        <div class="panel-heading">
			                        <div class="row">
			                        	<div class="col-xs-4">
			                          	...
			                          	<a href="<?=base_url('user/query/get');?>">
			                          	<div class="col-xs-8 text-right">
			                            	<h3 class="announcement-text">Contact</h3>
		                        ...
		                        <div class="panel-heading">
			                        <div class="row">
			                        	<div class="col-xs-6">
			                          	...
			                          	<div class="col-xs-6 text-right">
			                            	<h3 class="announcement-text">Profile</h3>
			                            	<p class="announcement-heading">View Profile</p>
			                          	</div>
			                          	</a>
			                        </div>
		                        </div>
