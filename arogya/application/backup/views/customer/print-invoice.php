                ...
                <tbody>
                 ...
                 <!-- <?php if($userData['discount']>=0) { ?>-->
                  <tr>
                    ...
                    <th class="txtright"><?php $disco = number_format($userData['discount']);?> &#8377;  <?= ($disco!='')?$disco.".00":"0.00" ?></th>
                  </tr>
                  <tr>
                    ...
                    <td class="txtright"><b style="color: red;"><?php $netpay = number_format($digit=$flat['total']+$plccharg+$devcharg-$userData['discount']);?> &#8377; <?=($netpay!='')?$netpay.".00":"0.00"; ?></b></td>
                  </tr>
                 <!-- <?php } ?>-->
                  <tr>
