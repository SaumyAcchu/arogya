...
<html lang="en">
<head>
  	<title><?=$page['page']='Associate Registration';?> | <?=$this->siteInfo['name'];?></title>
  	...
  	<div class="wrapper" id="wrapper">
	    ...
	    <div class="container" id="right-container">
             ...
             <!-- ///=====================All Contents Start Here============= //-->
                 ...
                 <div class="jumbotron">
                 <?= form_open_multipart('login/outherreg',['class'=>'form-horizontal','name'=>'myform','id'=>'regForm']); ?>
                   ...
                   <legend style="margin-top: 10px;">Member Details</legend>
                   <div class="form-group">
                  ...
                  <!--  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                     ...
                     <label class="col-sm-2 control-label">City</label>
                      <div class="col-sm-4">
                          <input type="text" value="" class="form-control noSpace" name="city" id="city" placeholder="City Name">
                          <span id="err_city"></span>
                      </div>
